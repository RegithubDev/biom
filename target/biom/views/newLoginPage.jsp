...
<head>
  ...
  <!--    <meta name="google-signin-client_id" content="180023549420-4araucipo8cil4matp902f64cte57md9.apps.googleusercontent.com">  -->
    ...
    <link rel="stylesheet" type="text/css" href="/reirm/resources/css/plugins/forms/form-validation.css">
    <link rel="stylesheet" type="text/css" href="/reirm/resources/css/pages/authentication.css">
    <!-- END: Page CSS-->
    <!-- BEGIN: Custom CSS-->
            ...
            <div class="auth-inner row m-0">
				          ...
				          <div id="carousel-example-caption" class="carousel slide" data-bs-ride="carousel">
				            ...
				            <div class="carousel-inner">
				              <div class="carousel-item active">
				                <img class="img-fluid" src="/reirm/resources/images/att.png" alt="First slide" />
				                ...
				                <img class="img-fluid" src="/reirm/resources/images/att2.png" alt="Third slide" />
				                <div class="carousel-caption d-none d-md-block">
				                  <!-- <p class="text-white">
              ...
              <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-2">
               <!-- Login basic -->
				...
				<!-- <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSeNwrxbH3CHEC-u3Uu63qt-sx01N4gmeJRJQ&s" href="https://resustainability.com/"  alt="logo" class="mb-2 ms-2" style="
    height: 6rem; ">-->

                <div style="color: red;" >${invalidEmail} ${multipleLoginFound}</div>
                <h3><strong>Welcome to</strong> Re Attendance System</h3>
              
                  <h4 class="mb-2"></h4>
                   <hr class="m-b-10 fr-text m-t-0">
                  <div class="p-10 text-center"> 
                     <img class="box-title m-b-15" src="/reirm/resources/images/login_icon.png"  height="107" width="102">      
    				<br></div>
	...
	<!-- 			 <div id="g_id_onload"
				...
				<div class="g_id_signin justify-content-center mt-1"
			        ...
			        <p class=" fr-text text-secondary">Incase of any login issue, connect on <a href="mailto:it.helpdesk@resustainability.com" class="link"><u>it.helpdesk@resustainability.com</u></a></p>
                 	<hr class="m-b-10 fr-text m-t-0">
                 	<p class=" fr-text">Signing up in this Our Portal confirms your acceptance to ReSL IT Application Usage Policy </p>
                 
             <div class="m-t-30 "><p class="font-10 fr-text">Attendance Portal © 2025. ReSL, All Rights Reserved.</p></div>
                </div>
